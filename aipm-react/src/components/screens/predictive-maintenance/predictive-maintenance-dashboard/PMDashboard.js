...
class PMDashboard extends Component {
  ...
  componentDidMount() {
    ...
    switch (this.props.robot) {
      case "yaskawa":
        axios
          .get("https://aipm-gsc-nodered.mybluemix.net/yaskawaHistory")
          .then(response => {
        ...
        axios
          .get("https://aipm-gsc-nodered.mybluemix.net/displayRanges")
          .then(response => {
      ...
      case "kuka":
        axios
          .get("https://aipm-gsc-nodered.mybluemix.net/kukaHistory")
          .then(response => {
      ...
      case "conveyor":
        axios
          .get("https://aipm-gsc-nodered.mybluemix.net/replayHistory")
          .then(response => {
    ...
    ws.onmessage = event => {
      ...
      switch (msg.msgType) {
        ...
        case "kukaRobotHealth":
          ...
          break;
        case "acousticInsights":
          // console.log("ai message received");
          this.setState({
            aiState: msg.state
          });
          this.setState({
            aiCategory: msg.category
          });
          this.setState({
  ...
  render() {
    let pmComponent = (
      <PMContainer
        ...
        pmHealthData={this.state.pmHealthData}
    ...
    return (
      <BasicCard>
        <div className="pmDataContainer">{pmComponent}</div>
      </BasicCard>
    );
  }
}
